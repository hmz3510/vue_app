...
router.get("/cartImg",(req,res)=>{
    var obj = [
        {id:1,img_url:"http://localhost:4000/images/shop-tab/01.png",title:"待付款"},
        {id:2,img_url:"http://localhost:4000/images/shop-tab/02.png",title:"待发货"},
        {id:3,img_url:"http://localhost:4000/images/shop-tab/03.png",title:"待收货"},
        {id:4,img_url:"http://localhost:4000/images/shop-tab/04.png",title:"待评价"},
        {id:5,img_url:"http://localhost:4000/images/shop-tab/05.png",title:"退货"}
    ]
    res.send(obj);
})
